    ...
    def setup(self) -> None:
        ...
        try:
            ...
            try:
                ...
                slicer.util.infoDisplay("Dependencies from the SlicerMorph Extension not found. Please manually install SlicerMorph from the Extension Manager")
                print("Dependencies from the SlicerMorph Extension not found. Please manually install SlicerMorph from the Extension Manager")
            slicer.util.selectModule(slicer.modules.mirrororbitrecon)
